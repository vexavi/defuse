(() => {
  ...
  const directionRules = {
    SCHOOL: ["up", "right", "up"],
    PARK: ["left", "up", "left"],
    LIBRARY: ["down", "right", "right", "up"],
    STATION: ["right", "down", "left", "up"],
    HOSPITAL: ["up", "up", "left", "down", "right"],
    SUPERMARKET: ["right", "right", "up", "left", "up"],
    RESTAURANT: ["down", "left", "up", "right", "down", "left"],
    POST_OFFICE: ["left", "down", "right", "up"],
    MUSEUM: ["up", "left", "down", "right", "up", "left"],
    AIRPORT: ["right", "up", "right", "down", "left"],
    HOTEL: ["down", "down", "right"],
    BANK: ["left", "up", "right", "right", "down"],
    ZOO: ["up", "right", "down", "left", "up", "right"],
    CITY_HALL: ["right", "left", "up", "down"],
  };
  ...
  function renderDirections(module) {
    addInstruction("Tell your partner the place on the display. Press all arrows in the order they give you.");
