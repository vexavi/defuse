(() => {
  ...
  function renderCalculator(module) {
    ...
    first.className = "calculator-number";
    first.textContent = module.first;
    ...
    second.className = "calculator-number";
    second.textContent = module.second;
  ...
  function failLevel(reason) {
    ...
    document.getElementById("resultTitle").textContent = `Level ${state.levelNumber} Failed`;
    document.getElementById("resultText").textContent =
      `${reason} You must clear Level ${state.levelNumber} before advancing.`;

    playAgainBtn.textContent = `Retry Level ${state.levelNumber}`;
    resultAction = "retry";
    showScreen("result");
  }
